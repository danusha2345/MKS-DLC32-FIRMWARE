...
> ⚠️ Бинарники в `release/` собраны до миграции на arduino-esp32 2.0.17 и не содержат
> последних фиксов (SD-печать, стабильность, Trinamic). Актуальную прошивку пока нужно
> собирать из исходников — см. «Сборка» ниже.
